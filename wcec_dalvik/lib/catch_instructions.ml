...
let catch i = 
  ...
  |"if-eq" -> Op3(IfEq,Empty)
  |"if-ne" -> Op3(IfNe,Empty)
  |"if-lt" -> Op3(IfLt,Empty)
  |"if-ge" -> Op3(IfGe,Empty)
  |"if-gt" -> Op3(IfGt,Empty)
  |"if-le" -> Op3(IfLe,Empty)
  |"if-eqz" -> Op3(IfEqz,Empty)
  |"if-nez" -> Op3(IfNez,Empty)
  |"if-ltz" -> Op3(IfLtz,Empty)
  |"if-gez" -> Op3(IfGez,Empty)
  |"if-gtz" -> Op3(IfGtz,Empty)
  |"if-lez" -> Op3(IfLez,Empty)
